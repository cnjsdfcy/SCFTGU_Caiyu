...
int sc_main(int argc, char* argv[]) {
  ...
  //cout << "Simulator finished at " << time_flies_i.display_hms(sc_simulation_time()); //sc_simulation_time() is deprecated
  cout << "Simulator finished at " << time_flies_i.display_hms(sc_time_stamp().to_seconds());
  cout << endl;
