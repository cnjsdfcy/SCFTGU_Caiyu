...
void turn_of_events::turn_knob_thread(void) {
  ...
  char direction;
  wait(SC_ZERO_TIME); //0-WAIT is the key for letting all threads in positon before inputs in
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//END $Id: turn_of_events.cpp,v 1.4 2004/02/02 12:46:14 dcblack Exp $
