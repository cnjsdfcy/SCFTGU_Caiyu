...
void gas_station::attendant_method(void) {
  ...
  if (!m_filling) {
    ...
    e_filled.notify(sc_core::SC_ZERO_TIME); // We finished filling (4) & are available!
...
std::string gas_station::hms(void) {
  ...
  double mins(sc_core::sc_simulation_time());
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//END $Id: gas_station.cpp,v 1.3 2004/02/02 12:37:47 dcblack Exp $
