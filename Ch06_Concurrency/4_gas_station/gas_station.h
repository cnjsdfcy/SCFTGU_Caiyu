...
SC_MODULE(gas_station) {
  ...
  double   m_filltime;
  sc_core::sc_event e_request1, e_request2;
  double   m_tank1, m_tank2;
  unsigned m_count1, m_count2, m_maxcount;
  sc_core::sc_event e_filled;
  ...
  gas_station(
    ...
    m_maxcount(maxcount),
    m_filling(false),
    t_MIN(1,sc_core::SC_NS) // treat 1 minute = 1 nanosecond
  {
    // Note parameters
...
#endif
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//END $Id: gas_station.h,v 1.3 2004/02/02 12:37:47 dcblack Exp $
