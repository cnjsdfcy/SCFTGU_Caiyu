...
SC_MODULE(next_trigger_example) {
  ...
  int count; // Used to make things more interesting
  SC_CTOR(next_trigger_example): my_state(STATE1), count(0) {
...
#endif
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//END $Id: next_trigger.h,v 1.2 2004/02/02 12:39:36 dcblack Exp $
