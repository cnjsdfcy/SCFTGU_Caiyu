...
void mutex_ex::parent_thread  (void) {
    ...
    for(;;) {
        ...
        //note: trylock() returns 0 if mutex is not locked yet!
        //                retruns -1 if it's locked already.
        if (0 == family_car.trylock()) { //see if car is available
...
void mutex_ex::note(const char* who, const char* message) {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//END $Id: mutex_ex.cpp,v 1.1 2003/11/25 12:55:40 dcblack Exp $
